    ...
    <div class="navbar" :class="{ '--big': active }" :style="getVars" ref="navbar">
      ...
      <ul class="navbar__links">
        <li
          ...
          :class="{ filled: mergedData.filled }"
        >
          <ENavbarLeftItem
            :link="link"
            :active="active"
  ...
  computed: {
    ...
    getVars() {
      return {
        ...
        '--chevron-color': this.styleConfig?.chevronColor || '#2D3748',
        ...
        '--list-item-padding': this.styleConfig?.listItemPadding || '0 20px',
        '--list-item-height': this.styleConfig?.listItemHeight || '40px',
        // ul
